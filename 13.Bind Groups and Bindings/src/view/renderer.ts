...
export class Renderer {
   ...
   async Initialize() {
    ...
    async createAssets() {
        ...
        await this.triangleMaterial.initialize(this.device, "./img/texture.jpg", this.materialGroupLayout);
        await this.quadMaterial.initialize(this.device, "./img/ground.jpg", this.materialGroupLayout);
    }
    ...
    async render(renderables: RenderData) {
        ...
        const renderpass : GPURenderPassEncoder = commandEncoder.beginRenderPass({
            colorAttachments: [{
                view: textureView,
                clearValue: {r: 0.6, g: 0.87, b: 0.88, a: 1.0},
                loadOp: "clear",
                storeOp: "store"
            }],
